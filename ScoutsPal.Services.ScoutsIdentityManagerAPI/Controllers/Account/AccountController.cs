...
using IdentityModel;
using ScoutsPal.Services.ScoutsIdentityManagerAPI.Controllers.Account;
...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
            ...
            RoleManager<IdentityRole> roleManager)
        {
            ...
            _serilogLogger = Log.ForContext<AccountController>();
        }
        ...
        {
            model.Roles = new List<string> { "Admin", "Standard" };
